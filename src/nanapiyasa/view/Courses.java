...
public class Courses extends javax.swing.JFrame {
    ...
    public Courses(String title) throws HeadlessException {
        initComponents();
        if(title=="ViewAll"){
            viewAll();
        }else{
   ...
   public void viewAll( ){
       ViewAllCourses f1=new ViewAllCourses();
        panel.removeAll();
   ...
   public void advancedSearch( ){
       AdvancedSearchCourse f1=new AdvancedSearchCourse();      
        panel.removeAll();
        f1.setSize(panel.getSize());
        Component add = panel.add(f1);
        panel.repaint();
    ...
    private void initComponents() {
        ...
        jPanel3.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 30, 900, 630));

        panel.add(jPanel3);
        jPanel3.setBounds(-240, -30, 900, 630);

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/nanapiyasa/view/Images/background2.png"))); // NOI18N
        panel.add(jLabel2);
        jLabel2.setBounds(70, 10, 660, 528);
